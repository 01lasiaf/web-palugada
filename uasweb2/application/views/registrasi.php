          ...
          <div class="col-lg">
            <div class="p-5">
              ...
              <form method="post" action="<?php echo base_url('registrasi/index') ?>" class="user">
                ...
                <button type="submit" class="btn btn-primary btn-user btn-block mb">Daftar</button>
                
              </form>
              <hr>
             
              <div class="text-center">
                <a class="small" href="<?php echo base_url('auth/login') ?>">Sudah Punya Akun ??? Langsung Login Aja!</a>
              </div>
            </div>
          </div>
        </div>
