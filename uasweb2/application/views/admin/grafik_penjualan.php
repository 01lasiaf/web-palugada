...
<body>
    ...
    table{
        ...
        <center>
        <h2>DATA BARANG BERDASARKAN KATEGORI DATABASE<br/>- <?php echo $this->session->userdata('nama') ?> -</h2>
    </center>
        ...
        var myChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    ...
                    ?>, 
                    <?php 
                    $jumlah_pakaian = mysqli_query($koneksi,"select * from tb_barang where kategori='pakaian'");
                    echo mysqli_num_rows($jumlah_pakaian);
                    ?>, 
                    <?php 
